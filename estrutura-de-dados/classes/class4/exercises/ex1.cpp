...
int main(){
    ...
    cout << "Informe a quantidade de carros: " << endl;
    cin >> qty_cars;


    carSubscribe *car = new carSubscribe[qty_cars];
    ...
    for(int i = 0; i < qty_cars;i++){
        ...
        cout << "Informa a quantidade de reviews: " << endl;
        cin >> REVIEWS;

        car[i].car_review = new review[REVIEWS];
    ...
    for(int i =0; i< qty_cars;i++){
        ...
        for(int i_review  = 0; car[i].car_review[i].date != "";i_review++){
