public class Classe_crescente6{
    String meunome;
    public int numero1 = 0;
    public int numero2 = 0;
    public int numero3 = 0;

    public Classe_crescente6(String nome){
        meunome = nome;
    }
    public Classe_crescente6(){
        meunome = "Sem nome";
    }
    
    public static void ordenar(int numero1, int numero2, int numero3, String nome){
        System.out.println("\n" + nome + " sua ordem e: ");
        if(numero1 < numero2){
